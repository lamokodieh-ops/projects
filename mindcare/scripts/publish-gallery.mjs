/**
 * Copies the Vite production build into docs/mindcare for GitHub Pages.
...
const out = join(root, '..', 'docs', 'mindcare')
...
console.log('Live URL: https://lamokodieh-ops.github.io/projects/mindcare/')
